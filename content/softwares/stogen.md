...
Jean-Michel Brankart (IGE)


## Description 

*Adapted from Brankart, 2024)*

The STOGEN module is a piece of software to generate sotchastic perturbations:
...
+ This software is currently hosted on [J.M. Brankart's Github](https://github.com/brankart/stogen/tree/main).
+ It is availble under the [CeCILL free software License agreement](https://github.com/brankart/stogen/blob/main/LICENSE.txt).
